            ...
            child: Card(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Icon(Icons.qr_code_2, size: 52, color: Theme.of(context).colorScheme.primary),
                    const SizedBox(height: 12),
                    Text('Transforme seu texto em QR Code', style: Theme.of(context).textTheme.headlineSmall?.copyWith(fontWeight: FontWeight.bold), textAlign: TextAlign.center),
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        suffixText: _texto.length.toString() + '/120',
                      ),
                    ),
                    ...
                    AnimatedSwitcher(
                      ...
                      child: possuiConteudo
                          ...
                          : const Padding(
                              ...
                              child: Text('Digite algo para gerar seu QR Code', textAlign: TextAlign.center),
                            ),
                    ),
                  ],
                ),
